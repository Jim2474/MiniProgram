...
- `docs/REQUIREMENTS-AUDIT-V90.md`
...
- `docs/REQUIREMENTS-AUDIT-V86.md`
- `docs/ACCEPTANCE-V85.md`
- `docs/REQUIREMENTS-AUDIT-V85.md`
- `docs/ACCEPTANCE-V84.md`
- `docs/REQUIREMENTS-AUDIT-V84.md`
- `docs/ACCEPTANCE-V83.md`
- `docs/REQUIREMENTS-AUDIT-V83.md`
- `docs/ACCEPTANCE-V82.md`
- `docs/REQUIREMENTS-AUDIT-V82.md`
- `docs/ACCEPTANCE-V81.md`
- `docs/REQUIREMENTS-AUDIT-V81.md`
...
- 创建升盲本局时生成 `start` 语音事件。
- 重开本局时重新生成 `start` 语音事件。
- 冠军产生时生成 `end` 语音事件。
- 开始/结束事件使用后台配置的自定义语音文案。
...
- 后端新增咖位类型编辑接口，支持修改名称、默认人数和状态。
- 咖位类型新增/编辑均校验名称不能为空，并写入操作日志。
- 后台咖位类型表单支持填入编辑、保存咖位类型和启停类型。
- 自动验收覆盖咖位类型编辑、停用、空名称拦截、操作日志和小程序后台入口。
